...
//
//import com.ti.sistemareservaturnos.repository.config.SpringConfig;
...
//
//    private static OdontologoService odontologoService = new OdontologoService(new IOdontologoRepository(new SpringConfig()));
//
//    @BeforeClass
